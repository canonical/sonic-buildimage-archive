...
include $(PLATFORM_PATH)/platform-modules-netweb.mk
...
BCMCMD = bcmcmd
$(BCMCMD)_URL = "http://192.168.10.30/packages.trafficmanager.net/public/20190307/bcmcmd"

DSSERVE = dsserve
$(DSSERVE)_URL = "http://192.168.10.30/packages.trafficmanager.net/public/20190307/dsserve"
